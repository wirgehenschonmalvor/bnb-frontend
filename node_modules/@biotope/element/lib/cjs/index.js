...
const camelize = (input) => input.replace(/-([a-z])/g, (g) => g[1].toUpperCase());
...
const attributeNameMapper = (attr) => (typeof attr === 'string'
    ? attr
    : attr.name);

const createStyle = (styleContent) => {
...
class Component$1 extends HyperHTMLElement {
    ...
    // eslint-disable-next-line class-methods-use-this
    get wire() {
        return Component$1.wire;
    }
    // eslint-disable-next-line class-methods-use-this
    get hyper() {
        return Component$1.hyper;
    }
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        const attribute = this.constructor.attributes
            .find((attr) => attributeNameMapper(attr) === name);
        if (attribute) {
            this.props = Object.assign({}, this.props, { [camelize(name)]: typeof attribute === 'string' ? newValue : attribute.converter(newValue) });
        }
    }
    ...
    emit(name, detail, addPrefix = false) {
        if (!name) {
