...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ts/nested/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleChild\", function() { return ExampleChild; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <p>parent prop: \", \"</p>\\n      <p>my prop: \", \"</p>\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\nvar ExampleChild =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleChild, _Component);\n\n  function ExampleChild() {\n    return _Component.call(this, false) || this;\n  }\n\n  var _proto = ExampleChild.prototype;\n\n  _proto.render = function render() {\n    return this.html(_templateObject(), this.props.text, this.props.anotherText);\n  } // eslint-disable-next-line class-methods-use-this\n  ;\n\n  _proto.rendered = function rendered() {\n    // eslint-disable-next-line no-console\n    console.log('CHILD: elements are in the DOM');\n  };\n\n  return ExampleChild;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleChild.componentName = 'example-child';\nExampleChild.attributes = ['text', 'another-text'];\n\n//# sourceURL=webpack:///./src/ts/nested/child.ts?");

/***/ }),

/***/ "./src/ts/nested/index.ts":
/*!********************************!*\
  !*** ./src/ts/nested/index.ts ***!
  \********************************/
/*! exports provided: ExampleParent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleParent\", function() { return ExampleParent; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\n/* harmony import */ var _child__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./child */ \"./src/ts/nested/child.ts\");\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <div>\\n        <example-child\\n          text=\", \"\\n          another-text=\\\"Hello World\\\"\\n        />\\n      </div>\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\n\nvar ExampleParent =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleParent, _Component);\n\n  function ExampleParent() {\n    return _Component.call(this, false) || this;\n  }\n\n  var _proto = ExampleParent.prototype;\n\n  _proto.render = function render() {\n    return this.html(_templateObject(), this.props.text);\n  } // eslint-disable-next-line class-methods-use-this\n  ;\n\n  _proto.rendered = function rendered() {\n    // eslint-disable-next-line no-console\n    console.log('PARENT: elements are in the DOM');\n  };\n\n  return ExampleParent;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleParent.componentName = 'example-parent';\nExampleParent.attributes = ['text'];\nExampleParent.dependencies = [_child__WEBPACK_IMPORTED_MODULE_1__[\"ExampleChild\"]];\nExampleParent.register();\n\n//# sourceURL=webpack:///./src/ts/nested/index.ts?");
