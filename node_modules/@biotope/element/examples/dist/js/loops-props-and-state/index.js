...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/loops-props-and-state/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/js/loops-props-and-state/index.js":
/*!***********************************************!*\
  !*** ./src/js/loops-props-and-state/index.js ***!
  \***********************************************/
/*! exports provided: ExampleTable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleTable\", function() { return ExampleTable; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _templateObject3() {\n  var data = _taggedTemplateLiteral([\"\\n      <tr>\\n        <td>\", \"</td>\\n        <td>\", \"</td>\\n        <td>\", \"</td>\\n      </tr>\\n    \"]);\n\n  _templateObject3 = function _templateObject3() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _templateObject2() {\n  var data = _taggedTemplateLiteral([\"\\n        <button onclick=\", \">Increment Counter</button>\\n        <span>\", \"</span>\\n      \"]);\n\n  _templateObject2 = function _templateObject2() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <table>\\n        <thead>\\n          <tr>\\n            <th>Name</th>\\n            <th>Typeof</th>\\n            <th>Value</th>\\n          </tr>\\n        </thead>\\n        <tbody>\\n          \", \"\\n        </tbody>\\n      </table>\\n      \", \"\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\n\nvar kebabToCamel = function kebabToCamel(str) {\n  return str.replace(/([-_][a-z])/g, function (group) {\n    return group.toUpperCase().replace('-', '');\n  });\n};\n\nvar ExampleTable =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleTable, _Component);\n\n  function ExampleTable() {\n    var _this;\n\n    _this = _Component.call(this) || this;\n    _this.getRow = _this.getRow.bind(_assertThisInitialized(_this));\n    _this.handleClick = _this.handleClick.bind(_assertThisInitialized(_this));\n    _this.defaultProps = {\n      showCounter: false\n    };\n    _this.defaultState = {\n      counter: 0\n    };\n    return _this;\n  }\n\n  var _proto = ExampleTable.prototype;\n\n  _proto.render = function render() {\n    var showCounter = this.props.showCounter;\n    var counter = this.state.counter;\n    return this.html(_templateObject(), ExampleTable.attributes.map(this.getRow), showCounter ? this.html(_templateObject2(), this.handleClick, counter) : null);\n  };\n\n  _proto.getRow = function getRow(attribute) {\n    var name = typeof attribute === 'string' ? attribute : attribute.name;\n    return this.html(_templateObject3(), name, _typeof(this.props[kebabToCamel(name)]), JSON.stringify(this.props[kebabToCamel(name)]));\n  };\n\n  _proto.handleClick = function handleClick() {\n    this.setState({\n      counter: this.state.counter + 1\n    });\n  };\n\n  return ExampleTable;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleTable.componentName = 'example-table';\nExampleTable.attributes = ['simple-text', {\n  name: 'complex-attribute',\n  type: 'array'\n}, {\n  name: 'converted-attribute',\n  converter: function converter(prop) {\n    if (prop === 'one') {\n      return 1;\n    }\n\n    return prop === 'two' ? 2 : 0;\n  }\n}, {\n  name: 'show-counter',\n  type: 'boolean'\n}];\nExampleTable.register();\n\n//# sourceURL=webpack:///./src/js/loops-props-and-state/index.js?");
