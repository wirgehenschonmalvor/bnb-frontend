...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/events/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/js/events/child.js":
/*!********************************!*\
  !*** ./src/js/events/child.js ***!
  \********************************/
/*! exports provided: ExampleSenderEvents, ExampleSender */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleSenderEvents\", function() { return ExampleSenderEvents; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleSender\", function() { return ExampleSender; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <label>Label</label>\\n      <input ref=\", \" onkeyup=\", \" type=\\\"text\\\" />\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\nvar ExampleSenderEvents = {\n  change: 'examplesender.change'\n};\nvar ExampleSender =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleSender, _Component);\n\n  function ExampleSender() {\n    var _this;\n\n    _this = _Component.call(this) || this;\n    _this.handleChange = _this.handleChange.bind(_assertThisInitialized(_this));\n    _this.refs = {\n      input: Object(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"createRef\"])()\n    };\n    return _this;\n  }\n\n  var _proto = ExampleSender.prototype;\n\n  _proto.render = function render() {\n    return this.html(_templateObject(), this.refs.input, this.handleChange);\n  };\n\n  _proto.handleChange = function handleChange() {\n    // eslint-disable-next-line no-console\n    console.log('Emitting change on the input…');\n    this.emit(ExampleSenderEvents.change, this.refs.input.current.value);\n  };\n\n  return ExampleSender;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleSender.componentName = 'example-sender';\n\n//# sourceURL=webpack:///./src/js/events/child.js?");
...
/*!********************************!*\
  !*** ./src/js/events/index.js ***!
  \********************************/
/*! exports provided: ExampleReceiver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleReceiver\", function() { return ExampleReceiver; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\n/* harmony import */ var _child__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./child */ \"./src/js/events/child.js\");\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <div>\\n        <example-sender\\n          onclick=\", \"\\n          onexamplesender.change=\", \"\\n        />\\n      </div>\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\n\nvar ExampleReceiver =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleReceiver, _Component);\n\n  function ExampleReceiver() {\n    var _this;\n\n    _this = _Component.call(this) || this;\n    _this.handleClick = _this.handleClick.bind(_assertThisInitialized(_this));\n    _this.handleInputChange = _this.handleInputChange.bind(_assertThisInitialized(_this));\n    return _this;\n  }\n\n  var _proto = ExampleReceiver.prototype;\n\n  _proto.render = function render() {\n    return this.html(_templateObject(), this.handleClick, this.handleInputChange);\n  } // eslint-disable-next-line class-methods-use-this\n  ;\n\n  _proto.handleClick = function handleClick() {\n    // eslint-disable-next-line no-console\n    console.log('simple click example');\n  } // eslint-disable-next-line class-methods-use-this\n  ;\n\n  _proto.handleInputChange = function handleInputChange(_ref) {\n    var target = _ref.target,\n        detail = _ref.detail;\n    // eslint-disable-next-line no-console\n    console.log('Input change event on: ', target); // eslint-disable-next-line no-console\n\n    console.log('Current value for input: ', detail);\n  };\n\n  return ExampleReceiver;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleReceiver.componentName = 'example-receiver';\nExampleReceiver.dependencies = [_child__WEBPACK_IMPORTED_MODULE_1__[\"ExampleSender\"]];\nExampleReceiver.register();\n\n//# sourceURL=webpack:///./src/js/events/index.js?");
