...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/raw-attributes/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/js/raw-attributes/child.js":
/*!****************************************!*\
  !*** ./src/js/raw-attributes/child.js ***!
  \****************************************/
/*! exports provided: ExampleChild */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleChild\", function() { return ExampleChild; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\nfunction _templateObject3() {\n  var data = _taggedTemplateLiteral([\"\\n          <span>\", \",</span>\\n        \"]);\n\n  _templateObject3 = function _templateObject3() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _templateObject2() {\n  var data = _taggedTemplateLiteral([\"\\n          <span>\", \",</span>\\n        \"]);\n\n  _templateObject2 = function _templateObject2() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <h2>\", \"</h2>\\n      <p>Result: \", \"</p>\\n      <div>\\n        \", \"\\n      </div>\\n      <div>\\n        \", \"\\n      </div>\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\nvar ExampleChild =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleChild, _Component);\n\n  function ExampleChild() {\n    var _this;\n\n    _this = _Component.call(this) || this;\n    _this.defaultProps = {\n      myCallback: function myCallback(randomNumber) {\n        return randomNumber.toString();\n      },\n      myArray: [],\n      mySecondArray: [],\n      myInterpolated: ''\n    };\n    return _this;\n  }\n\n  var _proto = ExampleChild.prototype;\n\n  _proto.render = function render() {\n    var _this2 = this;\n\n    // eslint-disable-next-line no-console\n    console.log('child rendered');\n    var randomNumber = Math.round(Math.random() * 200 - 100) / 10;\n    return this.html(_templateObject(), this.props.myInterpolated, this.props.myCallback(randomNumber), this.props.myArray.map(function (value) {\n      return _this2.html(_templateObject2(), value + 1);\n    }), this.props.mySecondArray.map(function (value) {\n      return _this2.html(_templateObject3(), value * 12);\n    }));\n  };\n\n  return ExampleChild;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleChild.componentName = 'example-child';\nExampleChild.attributes = [{\n  name: 'my-interpolated'\n}, {\n  name: 'my-callback',\n  type: 'function'\n}, {\n  name: 'my-array',\n  type: 'array'\n}, {\n  name: 'my-second-array',\n  type: 'array'\n}];\nExampleChild.register();\n\n//# sourceURL=webpack:///./src/js/raw-attributes/child.js?");

/***/ }),

/***/ "./src/js/raw-attributes/index.js":
/*!****************************************!*\
  !*** ./src/js/raw-attributes/index.js ***!
  \****************************************/
/*! exports provided: ExampleText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ExampleText\", function() { return ExampleText; });\n/* harmony import */ var _biotope_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @biotope/element */ \"../lib/esm/index.js\");\n/* harmony import */ var _child__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./child */ \"./src/js/raw-attributes/child.js\");\nfunction _templateObject() {\n  var data = _taggedTemplateLiteral([\"\\n      <h1>H1 Headline</h1>\\n      <example-child\\n        my-callback=\", \"\\n        my-array=\", \"\\n        my-second-array=\", \"\\n        my-interpolated=\\\"I like the number \", \" very much!\\\"\\n      ></example-child>\\n    \"]);\n\n  _templateObject = function _templateObject() {\n    return data;\n  };\n\n  return data;\n}\n\nfunction _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }\n\nfunction _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }\n\n\n\nvar ExampleText =\n/*#__PURE__*/\nfunction (_Component) {\n  _inheritsLoose(ExampleText, _Component);\n\n  function ExampleText() {\n    var _this;\n\n    _this = _Component.call(this) || this;\n    _this.myArray = [1, 2, 3, 4, 5];\n    _this.randomNumber = Math.round(Math.random() * 10);\n    return _this;\n  }\n\n  var _proto = ExampleText.prototype;\n\n  _proto.render = function render() {\n    // eslint-disable-next-line no-console\n    console.log('parent rendered');\n    return this.html(_templateObject(), this.childCallback, this.myArray, JSON.stringify(this.myArray), this.randomNumber);\n  } // eslint-disable-next-line class-methods-use-this\n  ;\n\n  _proto.childCallback = function childCallback(number) {\n    var stringified = number >= 0 ? 'positive' : 'negative';\n    return \"Parent says that \\\"\".concat(number, \"\\\" is \").concat(number !== 0 ? stringified : 'zero');\n  };\n\n  return ExampleText;\n}(_biotope_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nExampleText.componentName = 'example-text';\nExampleText.dependencies = [_child__WEBPACK_IMPORTED_MODULE_1__[\"ExampleChild\"]];\nExampleText.register();\n\n//# sourceURL=webpack:///./src/js/raw-attributes/index.js?");
