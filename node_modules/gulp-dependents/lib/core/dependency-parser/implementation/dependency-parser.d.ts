...
export declare class DependencyParser implements IDependencyParser {
     ...
     */
    private getMatches(texts, regExpOrFunc);
    /**
     ...
     */
    private getPrefixedPathVariants(dependencyPaths, config);
    /**
     ...
     */
    private getPostfixedPathVariants(dependencyPaths, config);
    /**
     ...
     */
    private getBasePathVariants(dependencyPaths, config);
    /**
