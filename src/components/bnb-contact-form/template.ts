...
export const template = (): HTMLFragment => {
	return html`
		...
		></script>
		<script
			src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.15953"
			type="text/javascript"
		></script>
		<script type="text/javascript">
			JotForm.init(function() {
				...
				JotForm.alterTexts({
					...
					ccInvalidCVC: 'CVC-Nummer ist ungültig.',
					ccInvalidExpireDate: 'Ablaufdatum ungültig ist.',
					ccInvalidNumber: 'Ungültige Kontodaten',
					ccMissingDetails:
						'Bitte füllen Sie die Kreditkartenangaben aus.',
					ccMissingDonation:
						'Bitte geben Sie numerische Werte für Spendenbetrag.',
					ccMissingProduct: 'Bitte wählen Sie mindestens ein Produkt',
					characterLimitError:
						'Zu viele Zeichen. Die Grenze ist erreicht.',
					characterMinLimitError:
						'Zu wenige Zeichen. Das Minimum ist noch nicht erreicht.',
					confirmClearForm:
						'Sind Sie sicher, dass Sie das Formular leeren wollen?',
					confirmEmail: 'E-Mail ist nicht korrekt',
					currency: 'Diese Feld darf nur Währungswerte enthalten.',
					cyrillic:
						'Dieses Feld kann nur kyrillische Zeichen enthalten',
					dateInvalid:
						'Dieses Datum ist ung&amp;Atilde;&amp;frac14;ltig. Das Datumsformat ist wie folgt:',
					dateInvalidSeparate:
						'Dieses Datum ist nicht gültig. Geben Sie eine gültige {element}.',
					dateLimited:
						'Dieses Datum ist nicht verf&amp;Atilde;&amp;frac14;gbar.',
					disallowDecimals: 'Bitte geben Sie eine ganze Zahl.',
					email: 'Geben Sie eine gültige E-Mail Adresse ein',
					fillMask: 'Der Feldwert muss die Maske ausfüllen',
					freeEmailError:
						'Kostenlose E-Mail-Konten sind nicht erlaubt',
					generalError:
						'In Ihrem Formular sind Fehler. Bitte beheben Sie diese bevor Sie fortfahren.',
					generalPageError:
						'Es existieren Fehler auf dieser Seite. Bitte beseitigen Sie sie bevor Sie fortfahren.',
					gradingScoreError:
						'Gesamtbewertung sollte nur weniger als oder gleich sein zu',
					incompleteFields:
						'Es gibt unvollständige Pflichtfelder. Bitte füllen Sie diese aus. ',
					inputCarretErrorB:
						'Die Eingabe sollte nicht größer sein als der Maximalwert:',
					lessThan:
						'Ihre Bewertung sollte geringer als oder gleich sein wie',
					maxDigitsError: 'Die maximal erlaubten Ziffern sind',
					multipleFileUploads_emptyError:
						'{file} ist leer, bitte wählen Sie wieder Dateien ohne es.',
					multipleFileUploads_fileLimitError:
						'Nur {fileLimit} Dateiuploads sind erlaub!',
					multipleFileUploads_minSizeError:
						'{file} ist zu klein, minimale Dateigröße ist {minSizeLimit}.',
					...
					multipleFileUploads_typeError:
						'{file} hat einen ungültigen Erweiterung. Nur {extensions} sind erlaubt.',
					nextButtonText: 'Weiter',
					numeric: 'Dieses Feld darf nur numerische Werte enthalten',
					pastDatesDisallowed:
					...
					requireEveryRow: 'Jede Zeile benötigt.',
					requireOne: 'Mindestens ein Feld ist erforderlich.',
					seeAllText: 'Alle anzeigen',
					submissionLimit:
						'Es tut uns leid. Es ist nur ein Eintrag erlaubt. Mehrfacheinträge sind in diesem Formular deaktiviert.',
					submitButtonText: 'Absenden',
					uploadExtensions:
						'Sie k&amp;ouml;nnen nur folgende Dateien hochladen:',
					uploadFilesize:
						'Die Dateigröße kann nicht größer sein als:',
					uploadFilesizemin:
						'Die Dateigröße darf nicht tiefer sein als:',
					url: 'Dieses Feld kann nur eine gültige URL enthalten',
					wordLimitError: 'Zu viele Worte. Die Grenze ist erreicht.',
					wordMinLimitError:
						'Zu wenige Worte. Das Minimum ist noch nicht erreicht.',
				});
			...
			JotForm.prepareCalculationsOnTheFly([
				null,
				{ name: 'heading', qid: '1', text: null, type: 'control_head' },
				{
					name: 'submit2',
					qid: '2',
					text: 'Absenden',
		...
		<link
			type="text/css"
			rel="stylesheet"
			href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.15953"
		/>
		<link
			type="text/css"
			media="print"
			rel="stylesheet"
			href="https://cdn.jotfor.ms/css/printForm.css?3.3.15953"
		/>
		<link
			type="text/css"
			rel="stylesheet"
		...
		<form
			class="jotform-form"
			action="https://submit.jotformeu.com/submit/200645110551037/"
			method="post"
			name="form_200645110551037"
			id="200645110551037"
		...
		>
			...
			<div role="main" class="form-all">
				<ul class="form-section page-section">
					<li
						...
						id="id_3"
						data-compound-hint="Vorname,Nachname"
					>
						<label
					...
					<li
						...
						id="id_5"
						data-compound-hint="+49175,12345678"
					>
						<label
							class="form-label form-label-top form-label-auto"
							id="label_5"
						...
						<div id="cid_8" class="form-input-wide jf-required">
							...
							>
								...
								>
									...
									<input
										...
										id="input_8_0"
										name="q8_typeA[]"
										value="Datenschutzbestimmungen akzeptiert"
									/>
							...
							>Ich habe die
										<bnb-link external
											...
											target="_blank"
										></bnb-link>
										gelesen und akzeptiert.*</bnb-paragraph></label
									>
								</span>
							</div>
						</div>
          ...
          <li class="form-line" id="required-hint">
					...
					>
						...
						<div id="cid_7" class="form-input-wide jf-required">
							<section data-wrapper-react="true">
								<div
									id="recaptcha_input_7"
									data-component="recaptcha"
									data-callback="recaptchaCallbackinput_7"
									data-expired-callback="recaptchaExpiredCallbackinput_7"
								></div>
								<input
									type="hidden"
									id="input_7"
								...
								<script
									type="text/javascript"
									src="https://www.google.com/recaptcha/api.js?render=explicit&amp;onload=recaptchaLoadedinput_7"
								></script>
								<script type="text/javascript">
									var recaptchaLoadedinput_7 = function() {
										window.grecaptcha.render(
											...
											{
												sitekey:
													'6LdU3CgUAAAAAB0nnFM3M3T0sy707slYYU51RroJ',
											},
										);
										var grecaptchaBadge = document.querySelector(
											'.grecaptcha-badge',
										);
										if (grecaptchaBadge) {
											grecaptchaBadge.style.boxShadow =
												'gray 0px 0px 2px';
										}
									};
									...
									var recaptchaCallbackinput_7 = function() {
										...
										function triggerSubmit(formElement) {
											var button = formElement.ownerDocument.createElement(
												'input',
											);
			...
			<input
				...
				id="simple_spc"
				name="simple_spc"
				value="200645110551037"
			/>
			<script type="text/javascript">
				document.getElementById('si' + 'mple' + '_spc').value =
					'200645110551037-200645110551037';
			</script>
		</form>
		<script type="text/javascript">
